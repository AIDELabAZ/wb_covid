...
* agriculture 	
	...
	* round 6 ag vars
	...
	gen 			temp = cond(s06dq05b == 2, 0.0001, cond(s06dq05b == 1,1,.))
	...
	* create FAO crop code variable and populate with corresponding codes
	gen				ag_main_FAO = ag_main
	
	replace			ag_main_FAO = 108 if ag_main == 1 
	replace			ag_main_FAO = 104 if ag_main == 2 
	...
	replace			ag_main_FAO = 501 if ag_main == 16 
	replace			ag_main_FAO = 6020201 if ag_main == 17 
	replace			ag_main_FAO = 6020205 if ag_main == 18 
	replace			ag_main_FAO = 6020204 if ag_main == 19 
	replace			ag_main_FAO = 9030101 if ag_main == 20 

	replace			ag_main_FAO = 20106 if ag_main == 21 
	replace			ag_main_FAO = 20190 if ag_main == 22 
	replace			ag_main_FAO = 6020102 if ag_main == 23 
	replace			ag_main_FAO = 6020101 if ag_main == 24 
	replace			ag_main_FAO = 20502 if ag_main == 25 
	replace			ag_main_FAO = 20501 if ag_main == 26 
	replace			ag_main_FAO = 20105 if ag_main == 27 
	replace			ag_main_FAO = 20103 if ag_main == 28 
	replace			ag_main_FAO = 20203 if ag_main == 29 
	replace			ag_main_FAO = 20301 if ag_main == 30 
	
	replace			ag_main_FAO = 20202 if ag_main == 31 
	replace			ag_main_FAO = 20202 if ag_main == 32 
	replace			ag_main_FAO = 20304 if ag_main == 33 
	replace			ag_main_FAO = 20201 if ag_main == 34 
	replace			ag_main_FAO = 20204 if ag_main == 35 
	replace			ag_main_FAO = 20303 if ag_main == 36 
	replace			ag_main_FAO = 701 if ag_main == 37 
	replace			ag_main_FAO = 20204 if ag_main == 38 
	replace			ag_main_FAO = 20309 if ag_main == 39 
	replace			ag_main_FAO = 20302 if ag_main == 40 

	replace			ag_main_FAO = 20305 if ag_main == 41 
	replace			ag_main_FAO = 9020101 if ag_main == 43 
	replace			ag_main_FAO = 801 if ag_main == 44 
	replace			ag_main_FAO = 20302 if ag_main == 45 
	replace			ag_main_FAO = 505 if ag_main == 46 
	replace			ag_main_FAO = 504 if ag_main == 47 
	replace			ag_main_FAO = 60104 if ag_main == 48 
	replace			ag_main_FAO = 60101 if ag_main == 49 
	replace			ag_main_FAO = 60102 if ag_main == 50 
	
	replace			ag_main_FAO = 40403 if ag_main == 51 
	replace			ag_main_FAO = 904 if ag_main == 52 
	replace			ag_main_FAO = 302 if ag_main == 53 
	replace			ag_main_FAO = 30106 if ag_main == 54 
	replace			ag_main_FAO = 99 if ag_main == 55 
